// TODO: доделать класс, дописать обновление объектов с учетом стен
//  (найти какие номера тайлов соответствуют стенам, а какие полу), так же дописать нахождение координат новых;
//  нужен код блока пустого пространства и препятствия
class PhysicManager {
    constructor() {
